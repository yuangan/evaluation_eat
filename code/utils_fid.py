...
def calculate_activation_statistics(images, batch_size,return_act=False):
...
def calculate_fid(images1, images2, use_multiprocessing, batch_size,return_act=False):
    ...
    if return_act:
        return calculate_activation_statistics(images1, batch_size,return_act=True) , calculate_activation_statistics(images2, batch_size,return_act=True)
