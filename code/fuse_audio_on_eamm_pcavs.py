...
if __name__ == '__main__':
    args = get_args()
    vid_pths = glob.glob('/data4/talking_head_testing/25fps_video/no_crop/EAMM_pcavs/*.mp4')
    out_vid_rt = '/data4/talking_head_testing/25fps_video/no_crop/EAMM_pcavs_audio'
    ...
    for vid_pth in tqdm.tqdm(vid_pths):
        ...
        fuse_cmds = 'ffmpeg -loglevel error -y -i {} -i {} -vcodec copy {}'.format(vid_pth,wav_pth,out_pth)
        os.system(fuse_cmds)
        # assert(0)
